...
export class Registry__get_gaugesResult {
...
export class Registry__get_parametersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Registry__get_coin_indicesResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
...
export class Registry extends ethereum.SmartContract {
  ...
  get_gauges(_pool: Address): Registry__get_gaugesResult {
    let result = super.call(
      "get_gauges",
    ...
    return new Registry__get_gaugesResult(
  ...
  try_get_gauges(
    _pool: Address
  ): ethereum.CallResult<Registry__get_gaugesResult> {
    let result = super.tryCall(
      "get_gauges",
      "get_gauges(address):(address[10],int128[10])",
      [ethereum.Value.fromAddress(_pool)]
    ...
    return ethereum.CallResult.fromValue(
      new Registry__get_gaugesResult(
  ...
  get_parameters(_pool: Address): Registry__get_parametersResult {
    let result = super.call(
      "get_parameters",
    ...
    return new Registry__get_parametersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_get_parameters(
    _pool: Address
  ): ethereum.CallResult<Registry__get_parametersResult> {
    let result = super.tryCall(
      "get_parameters",
      "get_parameters(address):(uint256,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(_pool)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Registry__get_parametersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  get_coin_indices(
    ...
    _from: Address,
    _to: Address
  ): Registry__get_coin_indicesResult {
    let result = super.call(
      "get_coin_indices",
    ...
    return new Registry__get_coin_indicesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_get_coin_indices(
    ...
    _from: Address,
    _to: Address
  ): ethereum.CallResult<Registry__get_coin_indicesResult> {
    let result = super.tryCall(
      "get_coin_indices",
      "get_coin_indices(address,address,address):(int128,int128,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Registry__get_coin_indicesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean()
      )
